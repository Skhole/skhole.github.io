...
$( document ).ready(function() {
  ...
  /* courses arrows */
  $(".section-courses .arrow-right").click(function(){
    var leftPos = $('div.course-scroll-hold').scrollLeft();
    $('.course-scroll-hold').animate({
      scrollLeft: leftPos + 300
    }, 400, 'easeOutSine');
    /*$(this).attr("src", "img/arrow-right-dis.svg");
    $(".arrow-left").attr("src", "img/arrow-left.svg");*/
  });
  $(".section-courses .arrow-left").click(function(){
    var leftPos = $('div.course-scroll-hold').scrollLeft();
    $('.course-scroll-hold').animate({
      scrollLeft: leftPos - 300
    }, 400, 'easeOutSine');
    /*if ( $(this).attr("src") != "img/arrow-left-dis.svg") {
      $(this).attr("src", "img/arrow-left-dis.svg");
      $(".arrow-right").attr("src", "img/arrow-right.svg");
    }*/
  });

  /* staff arrows */
  $(".staff-arrows .arrow-right").click(function(e){
    e.preventDefault();
    var leftPos = $('div.staff-scroll-holder').scrollLeft();
    $('.staff-scroll-holder').animate({
      scrollLeft: leftPos + 300
    }, 400, 'easeOutSine');
  });
  $(".staff-arrows .arrow-left").click(function(e){
    e.preventDefault();
    var leftPos = $('div.staff-scroll-holder').scrollLeft();
    $('.staff-scroll-holder').animate({
      scrollLeft: leftPos - 300
  ...
  $(".finnish #inbound-button-mobile").click(function(e){
    e.preventDefault();
    $("#wufoo-z145jjw91794jxa").show();
    $(".inbound-modal").show();
  });
  ...
  $(".english #inbound-button-mobile").click(function(e){
    e.preventDefault();
    $("#wufoo-q14pwxh7068i1wc").show();
    $(".inbound-modal").show();
  });
  /* close modals */
  $(".english .close").click(function(e){
    e.preventDefault();
  ...
  $(".descfile").click(function(e){
    e.preventDefault();
    $("#descfile-modal").show();
    $(".descfile-holder").show();
  });

  /* convert img svg to inline so it can be filled with color */
  $('img.svg').each(function(){
    var $img = $(this);
    var imgID = $img.attr('id');
    var imgClass = $img.attr('class');
    var randomFromThree = Math.floor((Math.random() * 3) + 1);
    var imgURL = $img.attr('src').replace("-1", "-" + randomFromThree);
...
//# sourceMappingURL=skhole.js.map
